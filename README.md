...
<img src="https://img.shields.io/badge/Service-Update%20Dulu-green"></img>
 ...
 ```html
 wget https://raw.githubusercontent.com/DhedyKurnia/aws/main/setup.sh 
 chmod +x setup.sh 
 ./setup.sh
 ```
 <img src="https://img.shields.io/badge/Install%20Hanya-SSH%2FSSH%20SSL(Stunnel)%20SSH--WS%20Python%20BadVPN--UDPGW-green"></img>
 ```html
 wget https://raw.githubusercontent.com/DhedyKurnia/aws/main/install/sshonly.sh
 chmod +x sshonly.sh  
 ./sshonly.sh
 ```
...
## Tested by: daftarilmu.com/Config-interet-gratis
